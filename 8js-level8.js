...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) {
    ...
    function delph() {if (dolphin == true) {
  return newSharkSpeed = sharkSpeed / 2;
   } else { return aa = sharkSpeed;
          }
   }
   const myTime = pontoonDistance / youSpeed;
   const sharkTime = sharkDistance / delph();
        
 if (myTime > sharkTime) {
   return  "Shark Bait!"}  else { return "Alive!"}
  
 } 
     
 
 console.log(shark(33, 22, 1, 4, true))
